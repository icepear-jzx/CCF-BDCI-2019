...
class DFM(BaseEstimator, TransformerMixin):
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():
            ...
            if self.use_fm and self.use_deep:
                ...
                concat_input = tf.concaat([self.y_first_order, self.y_second_order], -1)
            elif self.use_deep:
            ...
            if self.optimizer_type == 'adam':
                ...
                self.optimizer = tf.trian.AdagradOptimizer(learning_rate=self.learning_rate, 
    ...
    def batch_norm_layer(self, x, train_phase, scope_bn):
        ...
        bn_inference = batch_norm(x, decay=self.batch_norm_decay, center=True, scale=True, updates_collections=None,
            is_training=False, reuse=None, trainable=True, scope=scope_bn)
    ...
    def fit_on_batch(self, Xi, Xv, y_):
        feed_dict = {
            self.feat_index: Xi,
            self.feat_value: Xv,
            self.label: y_,
    ...
    def fit(self, Xi_train, Xv_train, y_train,
        ...
        : param Xi_train: [[ind1_1, ind1_2, ...], [ind2_1, ind2_2, ...], ... , [indi_1, indi_2, ..., indi_j, ...], ...]
                          indi_j is the feature index of feature field j of sample i in the traning set
        : param Xv_train: [[val1_1, val1_2, ...], [val2_1, val2_2, ...], ... , [vali_1, vali_2, ..., vali_j, ...], ...]
                          vali_j is the feature value of feature field j of sample i in the training set
                          vali_j can be either binary or flaot
        : param y_train: label of each sample in the training set
        : param Xi_valid: list of list of feature indicies of each sample in the validation set
        : param Xv_valid: list of list of feature values of each in sample in the validation set
